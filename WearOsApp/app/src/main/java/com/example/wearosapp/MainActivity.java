...
public class MainActivity extends Activity {
    ...
    private ImageView imgx, imgy, imgz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sv = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent event) {
                ...
                txtX.setText("X = "+ String.valueOf((int)orientations[2]));
                txtY.setText("Y = "+ String.valueOf((int)orientations[1]));
                txtZ.setText("Z = "+ String.valueOf((int)orientations[0]));

                imgx.setRotation(-orientations[2]);
                imgy.setRotation(-orientations[1]);
                imgz.setRotation(-orientations[0]);
            }
            @Override
